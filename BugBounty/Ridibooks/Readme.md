...
다음 문서는 https://ridi.dev/bounty.html 를 복사하여 작성하였습니다.
...
- 최신 버전의 리디북스 페이퍼 펌웨어
- 그 외 paper.ridibooks.com, help.ridibooks.com을 제외한 *.ridibooks.com 도메인에서 제공되는 모든 서비스
...
### [🏆 명예의 전당](https://ridi.dev/hall-of-fame)